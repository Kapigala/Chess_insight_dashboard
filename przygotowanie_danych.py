...
f_g = {14204118: 'Abdusattorov (17)', 12573981: 'Firouzja (18)', 1503014: 'Carlsen (31)', 1170546: 'Duda (23)',
       2016192: 'Nakamura (34)', 4147103: 'Goryachkina (23)', 5000017: 'Anand (52)'}
...
for k in ['standard', 'rapid', 'blitz']:
    ...
    for n in range(len(p)):
        ...
        for i in ['2015', '2016', '2017', '2018', '2019', '2020']:
            ...
            z = dane[dane['fide_id'] == p[n]][
                ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']].values.tolist()
            zawodnik.extend(z[0])
